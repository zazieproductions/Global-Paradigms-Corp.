  ...
  return (
    <div className="border border-slate-700 bg-[#070a10] p-4 text-slate-300 font-mono-code text-xs rounded-sm">
      <div className="flex justify-between items-center border-b border-slate-800 pb-2 mb-3 text-[11px] text-slate-400">
        <div>
          <span className="font-bold text-cyan-400">FIG. 4-B</span> — PHONONIC DISPERSION & NEGATIVE-INDEX REFRACTION
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-[#04060a] border border-slate-800 p-2.5 rounded">
          ...
          <svg viewBox="0 0 260 140" className="w-full h-28">
            ...
            <path d="M 30 120 Q 65 95 100 80 Q 135 76 175 90 Q 210 105 250 120" fill="none" stroke="#00e5ff" strokeWidth="1.5" />
        ...
        <div className="bg-[#04060a] border border-slate-800 p-2.5 rounded">
          ...
          <svg viewBox="0 0 260 140" className="w-full h-28">
            ...
            {/* Incident ray */}
            <line x1="50" y1="20" x2="130" y2="70" stroke="#00e5ff" strokeWidth="2" />
            <polygon points="90,42 98,47 91,52" fill="#00e5ff" />
            <text x="60" y="38" fill="#00e5ff" fontSize="8">k_incident</text>
